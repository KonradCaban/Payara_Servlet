...
<nav class="navbar navbar-dark bg-dark">
  <a class="navbar-brand" href="#"><center>Księgarnia</center></a>
    ...
    <center>
		        <form action="/for_payara/CategoryServlet">
    		<input type="submit" value="Wróć do zarządzania kategoriami" class="btn btn-danger" />
    		<input type="hidden" name="dzialanie" value="/list">
		</form>
        <form method="get" action="CategoryServlet">
        <input type="hidden" name="dzialanie" value="/edit">
        <input type="hidden" name="id" value="<%= request.getParameter("id") %>">
        Zmień nazwę kategorii: <input type="text" name="name" value="<%= request.getParameter("name") %>" required><br><br>
        <input type="submit" value="Edytuj kategorię" class="btn btn-danger" />
        </form>
    </div>   
    </center>
</body>
